...
require __DIR__ . '/Api/raters.php';
...
//     Route::post('/draft', [rater_controller::class, 'draft_score']);
//     Route::post('/score', [rater_controller::class, 'store_score']);
...
//     Route::get('/', [ViewActiveController::class, 'getActiveCount']);http://localhost:9000/activity-log
...
//     Route::post('/store', [JobBatchesRspController::class, 'store']);   // change old job-batches-rsp
...
//     Route::post('/store', [OnCriteriaJobController::class, 'store']); // change old on-criteria-job
