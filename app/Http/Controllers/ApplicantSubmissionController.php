...
class ApplicantSubmissionController extends Controller
{
    ...
    //         // ✅ Get the applicant to check email
    //         $applicant = nPersonal_info::find($nPersonalInfoId);
    ...
    //             $nPersonalInfoId = $existingSubmission->nPersonalInfo_id;
    //             $applicant = $existingSubmission->nPersonalInfo;

    //             // Update existing applicant info with new data
    //             // This will be handled by your import logic, so we'll refresh it
    //             $applicant->refresh();
    //         }
