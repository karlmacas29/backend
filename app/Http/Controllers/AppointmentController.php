...
//             // ✅ Step A: Move old records to history if internal applicant
//             $oldRecords = DB::table('tempRegAppointmentReorg')
...
//             // ✅ Step B: Delete all old records from active table
//             DB::table('tempRegAppointmentReorg')
//                 ->where('ControlNo', $finalControlNo)
//                 ->delete();

//             $designation = DB::table('yDesignation')
//                 ->select('Codes', 'Descriptions', 'Status') // include Status
...
//             DB::table('xService')
//                 ->where('ControlNo', $finalControlNo)
//                 ->where('ToDate', '>', $fromDate) // e.g. 2075-09-15
//                 ->update([
//                     'ToDate' => Carbon::parse($fromDate)->subDay()
//                 ]);
